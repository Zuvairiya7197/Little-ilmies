...
export const products: ProductSummary[] = [
  {
    ...
    category: { slug: "islamic-studies", name: "Islamic Studies" },
    ageRange: "6-9",
    pageCount: 48,
    language: "English",
    format: "PDF",
  ...
  },
  {
    ...
    category: { slug: "character-building", name: "Character Building" },
    ageRange: "3-6",
    pageCount: 40,
    language: "English",
    format: "PDF",
  ...
  },
  {
    ...
    category: { slug: "quran-and-arabic", name: "Qur'an & Arabic" },
    ageRange: "6-9",
    pageCount: 52,
    language: "Arabic",
    format: "Printable PDF",
  ...
  },
  {
    ...
    category: { slug: "early-learning", name: "Early Learning" },
    ageRange: "0-3",
    pageCount: 38,
    language: "English",
    format: "Printable PDF",
  ...
  },
  {
    ...
    category: { slug: "creative-learning", name: "Creative Learning" },
    ageRange: "0-3",
    pageCount: 24,
    language: "English",
    format: "Printable PDF",
  ...
  },
  {
    ...
    category: { slug: "games-and-activities", name: "Games & Activities" },
    ageRange: "9-12",
    pageCount: 14,
    language: "English",
    format: "Printable PDF",
  ...
  },
  {
    ...
    coverImage: "/images/products/preschool-learning.svg",
    prices: regionalPrices({ inr: 34900, usd: 400 }),
    category: { slug: "mathematics", name: "Mathematics" },
    ageRange: "3-6",
    pageCount: 42,
    language: "English",
    format: "Printable PDF",
