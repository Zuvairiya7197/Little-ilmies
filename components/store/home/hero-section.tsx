...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[85vh] items-center justify-center overflow-hidden bg-cream-50 xs:min-h-[90vh]">
      <HeroVideoBackground />

      <div className="container-content relative flex flex-col items-center px-4 py-16 text-center xs:py-20 md:py-28">
        <span className="section-eyebrow animate-fade-up inline-flex items-center gap-2 rounded-full border border-sage-200 bg-cream-50/80 px-4 py-1.5 shadow-soft backdrop-blur-md">
