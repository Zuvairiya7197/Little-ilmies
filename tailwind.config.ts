  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Rainbow accent family — matches the bands in the Little Ilmies
        // logo (purple/orange/yellow/teal/pink claymorphism rainbow).
        // Used for category/collection/badge accents; ink stays the
        // primary brand color for buttons, price, and CTAs.
        sunny: {
          DEFAULT: "#F5A623",
          50: "#FEF6E9",
          100: "#FCE6C0",
